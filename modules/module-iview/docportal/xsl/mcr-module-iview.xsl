...
<!-- ============================================== -->
<!-- $Revision: 1.1 $ $Date: 2007-01-12 14:47:04 $ -->
<!--  												-->
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
	xmlns:xlink="http://www.w3.org/1999/xlink" exclude-result-prefixes="xlink i18n mcrxml" xmlns:i18n="xalan://org.mycore.services.i18n.MCRTranslation" xmlns:mcrxml="xalan://org.mycore.common.xml.MCRXMLFunctions">
	...
	<xsl:variable name="iview.home"
		select="concat($ServletsBaseURL,'MCRIViewServlet/')"/>	
	...
	<xsl:variable name="MCR.Module-iview.thumbnail.size.vertical"
		select="($MCR.Module-iview.thumbnail.size*3) div 4"/>
...
<!--  #####################################################################################################################-->
	...
	<xsl:template name="viewer.head">
        ...
        <xsl:value-of select="concat('current language: ',$CurrentLang)"/>
			...
			<script
			src="{$WebApplicationBaseURL}modules/module-iview/web/JS/module-iview.js"
			type="text/javascript"/>

			<link
				href="{$WebApplicationBaseURL}modules/module-iview/web/CSS/iviewstyle.css"
				rel="stylesheet"/>
						...
						<tr id="iview-base">
							...
							<td id="iview-simplesize">
								<table>
									<tr>
										<td>
											<a class="iview-simplesize"
												title="{i18n:translate('iview.adjustSide')}" 
										...
										<td>
											<a class="iview-simplewidth"
												title="{i18n:translate('iview.adjustWidth')}" 
									...
									<td>
										<table id="iview-filemenu" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td>
													<a class="iview-filemenuprint"
														title="{i18n:translate('iview.print')}" href="#"
														align="middle">
														<xsl:text
												...
												<td>
<!--													<a class="iview-filemenusaved"
														title="Speichern (verboten)"
														href="#" align="middle">
														<xsl:text
															disable-output-escaping="yes">
															&amp;nbsp;</xsl:text>
												...
												<td>
<!--													<a class="iview-filemenusendd"
														title="Senden (verboten)"
														href="#" align="middle">
														<xsl:text
															disable-output-escaping="yes">
															&amp;nbsp;</xsl:text>
										...
										<table id="iview-displayswitch" cellspacing="0" cellpadding="0">
											<tr>
												<td>
													...
													<a class="iview-displayswitchthumbs"
														title="{i18n:translate('iview.thumbs')}"
														href="{$iviewDisplayswitchthumbs}"
														align="middle">
														<xsl:text
															disable-output-escaping="yes">
															&amp;nbsp;</xsl:text>
												...
												<td>
													<xsl:variable
														name="iviewDisplayswitchpicture">
														<xsl:value-of
															select="concat($iview.home,$nodeToBeDisplayedPath,$HttpSession,'?mode=generateLayout&amp;XSL.MCR.Module-iview.style.SESSION=image')"/>
													</xsl:variable>
													<a class="iview-displayswitchpicture"
														title="{i18n:translate('iview.viewPic')}"
														href="{$iviewDisplayswitchpicture}"
														align="middle">
														<xsl:text
															disable-output-escaping="yes">
															&amp;nbsp;</xsl:text>
												...
												<td>
													<xsl:variable
														name="iviewDisplayswitchtext">
														<xsl:value-of
															select="concat($iview.home,$nodeToBeDisplayedPath,$HttpSession,'?mode=generateLayout&amp;XSL.MCR.Module-iview.style.SESSION=text')"/>
													</xsl:variable>
													<a class="iview-displayswitchtext"
														title="{i18n:translate('iview.overview')}"
														href="{$iviewDisplayswitchtext}"
														align="middle">
														<xsl:text
															disable-output-escaping="yes">
															&amp;nbsp;</xsl:text>
											...
											<tr>
												<td>
													<xsl:choose>
														...
														<xsl:otherwise>
															<a class="iview-viewoptionssmall"
																title="{i18n:translate('iview.scaleDown')}"
																href="{$MCR.Module-iview.lastEmbeddedURL}" 
																align="middle">
																<xsl:text
																	disable-output-escaping="yes">
																	&amp;nbsp;</xsl:text>
													...
													<xsl:choose>
														<xsl:when test="$MCR.Module-iview.embedded='true'">		
															<a class="iview-viewoptionslarg"
																title="{i18n:translate('iview.scaleUp')}" 
...
<!--												<td>
													<a class="iview-viewoptionsclose"
														title="iView schlie?en" href="#"
														align="middle">
														<xsl:text
															disable-output-escaping="yes">
															&amp;nbsp;</xsl:text>
						...
						<xsl:if test="$MCR.Module-iview.display = 'extended' ">
							<tr id="iview-enhanced">
								<td id="iview-smalllogo">
									<div align="center">
										<a class="dummyview2"
											title="{i18n:translate('iview.hideAdvMenu')}" 
												...
												<table>
													...
													<tr>
														<td colspan="3" class="h-nav">
															<div align="center">
																...
																<a
																	id="iview-orientationupID"
																	class="iview-orientationup"
													...
													<tr>
														<td class="v-nav">
															...
															<a id="iview-orientationleftID"
																class="iview-orientationleft"
														...
														<td class="thumbnail" >
																...
																<div style="overflow: hidden; position:relative;width:{$thumbWidth}px;height:{$thumbHeight}px;background-image:url({concat($iview.home,mcrxml:regexp(string($nodeToBeDisplayedPath), ' ', '%20'),$HttpSession,'?mode=getImage&amp;XSL.MCR.Module-iview.navi.zoom=thumbnail')});">
																	<div id="previewImage" >
														...
														<td class="v-nav">
															...
															<a  id="iview-orientationrightID"
																class="iview-orientationright"
													...
													<tr>
														...
														<div align="center">
																...
																<a
																	id="iview-orientationdownID"
																	class="iview-orientationdown"
	...
	<xsl:template name="get.setupJS">
		...
		<xsl:choose>
			<xsl:when test="$MCR.Module-iview.style='image'" >
				...
				<xsl:choose>
					<xsl:when test="$MCR.Module-iview.display='extended' and $currentZoom!='fitToScreen'">
		               ...
		               <!--<xsl:value-of select="concat('setupContentArea();setupImage(&#34;',$setMetadataURL,'&#34;,&#34;',$imageToBeDisplayedPath,'&#34;);setupHighlight(&#34;',$x,'&#34;,&#34;',$y,'&#34;,&#34;',$sf,'&#34;,&#34;',$zoom,'&#34;,&#34;',$thumbWidth,'&#34;,&#34;',$thumbHeight,'&#34;);')"/>-->	
						<xsl:value-of select="concat('setupContentArea();setupImage(&#34;',$setMetadataURL,'&#34;,&#34;',$imageToBeDisplayedPath,'&#34;,&#34;',$zoom,'&#34;,&#34;',$origWidth,'&#34;,&#34;',$origHeight,'&#34;);setupHighlight(&#34;',$x,'&#34;,&#34;',$y,'&#34;,&#34;',$sf,'&#34;,&#34;',$zoom,'&#34;,&#34;',$thumbWidth,'&#34;,&#34;',$thumbHeight,'&#34;);')"/>												
					</xsl:when>
					<xsl:otherwise>
		               <!--<xsl:value-of select="concat('setupContentArea();setupImage(&#34;',$setMetadataURL,'&#34;,&#34;',$imageToBeDisplayedPath,'&#34;);')"/>-->
						<xsl:value-of select="concat('setupContentArea();setupImage(&#34;',$setMetadataURL,'&#34;,&#34;',$imageToBeDisplayedPath,'&#34;,&#34;',$zoom,'&#34;,&#34;',$origWidth,'&#34;,&#34;',$origHeight,'&#34;);')"/>						
					</xsl:otherwise>
				</xsl:choose>
			</xsl:when>
			<xsl:otherwise>
	...
	<xsl:template name="prepareImageInfo">
		<xsl:for-each
			select="/mcr-module/iview/content/nodes/node[@type='file']">
	...
	<xsl:template name="image.info">
		<xsl:param name="node"/>
		<p> <xsl:value-of select="concat(i18n:translate('iview.name'),':')"/>
			<xsl:value-of select="name"/>
			<br/> <xsl:value-of select="concat(i18n:translate('iview.fileSize'),':')"/>
			<xsl:value-of select="size"/> <xsl:value-of select="concat(i18n:translate('iview.bytes'),':')"/>
			<br/> <xsl:value-of select="concat(i18n:translate('iview.format'),':')"/>
			<xsl:value-of select="contentType"/>
			<xsl:if test="width | height" >
				<br/> 
				<xsl:value-of select="concat(i18n:translate('iview.imageSize'),':')"/> <xsl:value-of select="width"/> x <xsl:value-of select="height"/>px
			</xsl:if>
			<br/> <xsl:value-of select="concat(i18n:translate('iview.lastChanged'),':')"/>
	...
	<xsl:template name="areaAbove.sort">
		<xsl:variable name="targetURL">
			<xsl:value-of
				select="concat($iview.home,$nodeToBeDisplayedPath,$HttpSession,'?mode=generateLayout')"/>
		</xsl:variable>
...
<!--			<select name="XSL.MCR.Module-iview.defaultSort">				-->
				<xsl:choose>
					<xsl:when test="$MCR.Module-iview.defaultSort = 'name'">
						<option value="name" selected="selected"><xsl:value-of select="concat(i18n:translate('iview.name'),' ',i18n:translate('iview.current'))"/></option>
					</xsl:when>
					<xsl:otherwise>
						<option value="name"><xsl:value-of select="i18n:translate('iview.name')"/></option>
					</xsl:otherwise>
				</xsl:choose>
				<xsl:choose>
					<xsl:when test="$MCR.Module-iview.defaultSort = 'size'">
						<option value="size" selected="selected"><xsl:value-of select="concat(i18n:translate('iview.fileSize'),' ',i18n:translate('iview.current'))"/></option>
					</xsl:when>
					<xsl:otherwise>
						<option value="size"><xsl:value-of select="i18n:translate('iview.fileSize')"/></option>
					</xsl:otherwise>
				</xsl:choose>
				<xsl:choose>
					<xsl:when
						test="$MCR.Module-iview.defaultSort = 'lastModified'">
						<option value="lastModified" selected="selected"><xsl:value-of select="concat(i18n:translate('iview.lastChanged'),' ',i18n:translate('iview.current'))"/></option>
					</xsl:when>
					<xsl:otherwise>
						<option value="lastModified"><xsl:value-of select="i18n:translate('iview.lastChanged')"/></option>
					</xsl:otherwise>
				</xsl:choose>
			</select>
...
<!--			<select name="XSL.MCR.Module-iview.defaultSort.order">-->
			<select name="XSL.MCR.Module-iview.defaultSort.order.SESSION">				
				<xsl:choose>
					<xsl:when
						test="$MCR.Module-iview.defaultSort.order = 'ascending'">
						<option value="ascending" selected="selected"><xsl:value-of select="concat(i18n:translate('iview.ascending'),' ',i18n:translate('iview.current'))"/></option>
						<option value="descending"><xsl:value-of select="i18n:translate('iview.descending')"/></option>
					</xsl:when>
					<xsl:otherwise>
						<option value="ascending"><xsl:value-of select="i18n:translate('iview.ascending')"/></option>
						<option value="descending" selected="selected"><xsl:value-of select="concat(i18n:translate('iview.descending'),' ',i18n:translate('iview.current'))"/></option>
					</xsl:otherwise>
				</xsl:choose>
			</select>
		</form>
	...
	<xsl:template name="areaAbove.zooming">
		...
		<table Cleaned="text-align: left; width: 100%; height: 25px;"
			...
			<tr>
				<td colspan="2">
					<form id="zoomLevel"
						action="{concat($iview.home,$fileToBeDisplayedPath,$HttpSession,'?mode=generateLayout')}"
						method="post">
						<select
							onChange="document.getElementById('zoomLevel').submit()"
							name="XSL.MCR.Module-iview.navi.zoom.SESSION">
							<xsl:call-template
								name="areaAbove.zooming.preselect">
								<xsl:with-param name="zoom"
									select="'fitToScreen'"/>
							</xsl:call-template>
							<xsl:call-template
								name="areaAbove.zooming.preselect">
	...
	<xsl:template name="areaAbove.zooming.preselect">
		...
		<xsl:choose>
			<xsl:when test="$zoom = /mcr-module/iview/header/currentZoom">
				<xsl:choose>
					<xsl:when test="$zoom = 'fitToScreen'">
						<option selected="selected" value="{$zoom}"><xsl:value-of select="i18n:translate('iview.side')"/></option>
					</xsl:when>
					<xsl:when test="$zoom = 'fitToWidth'">
						<option selected="selected" value="{$zoom}"><xsl:value-of select="i18n:translate('iview.width')"/></option>
					</xsl:when>
					<xsl:otherwise>
			...
			<xsl:otherwise>
				<xsl:choose>
					<xsl:when test="$zoom = 'fitToScreen'">
						<option value="{$zoom}"><xsl:value-of select="i18n:translate('iview.side')"/></option>
					</xsl:when>
					<xsl:when test="$zoom = 'fitToWidth'">
						<option value="{$zoom}"><xsl:value-of select="i18n:translate('iview.width')"/></option>
					</xsl:when>
					<xsl:otherwise>
						<option value="{$zoom}">
							<xsl:value-of select="$zoom"/>
			...
			<tr>
				<td>
					...
					<xsl:choose>
						<xsl:when test="$fileToBeDisplayedPath.first != ''">
							<xsl:variable
								name="fileToBeDisplayedPath.first.link">
								<xsl:value-of
									select="concat($iview.home,$fileToBeDisplayedPath.first,$HttpSession,'?mode=generateLayout&amp;XSL.MCR.Module-iview.move=reset')"/>
							</xsl:variable>
							<a class="iview-navigationfirst" title="{i18n:translate('iview.firstPic')}"
								href="{$fileToBeDisplayedPath.first.link}"
								align="middle">
								<xsl:text disable-output-escaping="yes">
									&amp;nbsp;</xsl:text>
							</a>
				...
				<td>
					...
					<xsl:choose>
						<xsl:when test="$fileToBeDisplayedPath.previous != ''">
							<xsl:variable
								name="fileToBeDisplayedPath.previous.link">
								<xsl:value-of
									select="concat($iview.home,$fileToBeDisplayedPath.previous,$HttpSession,'?mode=generateLayout&amp;XSL.MCR.Module-iview.move=reset')"/>
							</xsl:variable>
							<a class="iview-navigationback" title="{i18n:translate('iview.prevPic')}"
								href="{$fileToBeDisplayedPath.previous.link}"
								align="middle">
								<xsl:text disable-output-escaping="yes">
									&amp;nbsp;</xsl:text>
							</a>
				...
				<td>
					<xsl:variable name="imageNumber">
						<xsl:value-of
							select="concat($currentNodePosition+1,'/',count(/mcr-module/iview/content/nodes/node[@type='file']))"/>
					</xsl:variable>
				...
				<td>
					...
					<xsl:choose>
						<xsl:when test="$fileToBeDisplayedPath.next != ''">
							...
							<a class="iview-navigationforward"
								title="{i18n:translate('iview.nextPic')}"
								href="{$fileToBeDisplayedPath.next.link}"
								align="middle">
								<xsl:text disable-output-escaping="yes">
									&amp;nbsp;</xsl:text>
							</a>
				...
				<td>
					...
					<xsl:choose>
						<xsl:when test="$fileToBeDisplayedPath.last != ''">
							...
							<a class="iview-navigationlast" title="{i18n:translate('iview.lastPic')}"
								href="{$fileToBeDisplayedPath.last.link}"
								align="middle">
								<xsl:text disable-output-escaping="yes">
									&amp;nbsp;</xsl:text>
							</a>
			...
			<tr>
				<td align="center">
					...
					<xsl:if test="/mcr-module/iview/content/parent != ''">
						<a
							href="{concat($iview.home,iview/content/parent,$HttpSession,'?mode=generateLayout')}">
							<xsl:value-of select="i18n:translate('iview.parentDir')"/></a>
						<br/>
					</xsl:if>
					<!--generate thumbnail list-->
					<!--generate thumbnail list __ dirs -->
					<xsl:for-each
						select="/mcr-module/iview/content/nodes/node[@type='directory']">
						<xsl:sort select="name" order="ascending"/>
						<xsl:variable name="currentNode">
							<xsl:value-of
								select="concat($iview.home,$path,'/',name)"/>
						</xsl:variable>
					...
					<xsl:for-each
						...
						<a
							...
							<xsl:choose>
								<xsl:when
									test="$MCR.Module-iview.style='thumbnails'">
									<img style="border-style:none;"
										src="{concat($currentNode,'?mode=getImage&amp;XSL.MCR.Module-iview.navi.zoom=thumbnail')}"/>
								</xsl:when>
								<xsl:otherwise>
									<p align="left">
										<xsl:call-template name="image.info">
	...
	<xsl:template name="get.fileToBeDisplayedPath">
		<xsl:choose>
			...
			<xsl:when test="/mcr-module/iview/content/fileToBeDisplayed != ''">
				<xsl:value-of
					select="concat ($ownerID,/mcr-module/iview/content/fileToBeDisplayed) "/>
			</xsl:when>
			
			
			<!--fileToBeDisplayed NOT contained in xml & node[@type=file] found -->
			<xsl:when
				test="(/mcr-module/iview/content/nodes/node[@type='file']/name != '')">
				<xsl:value-of
					select="concat($path,'/',/mcr-module/iview/content/nodes/node[@type='file']/name) "/>
			</xsl:when>
			<xsl:otherwise>
				<xsl:value-of select="''"/>
			</xsl:otherwise>
	...
	<xsl:template name="get.fileToBeDisplayedPath.previous">
		<xsl:if test="($fileToBeDisplayedPath != '')">
			<xsl:for-each
				select="/mcr-module/iview/content/nodes/node[@type='file']">
				<xsl:if
					test="contains($fileToBeDisplayedPath,name) and (preceding-sibling::node()[@type='file']/name != '') ">
					<xsl:for-each
						select="preceding-sibling::node()[@type='file']">
	...
	<xsl:template name="get.fileToBeDisplayedPath.next">
		<xsl:if test="($fileToBeDisplayedPath != '')">
			<xsl:for-each
				select="/mcr-module/iview/content/nodes/node[@type='file']">
				<xsl:if
					test="contains($fileToBeDisplayedPath,name) and (following-sibling::node()[@type='file']/name != '')">
					<xsl:value-of
						select="concat($path,'/',following-sibling::node()[@type='file']/name)"/>
				</xsl:if>
			</xsl:for-each>
		</xsl:if>
	</xsl:template>
		...
		<xsl:if test="($fileToBeDisplayedPath != '')">
			<xsl:for-each
				...
				<xsl:if
					test="contains($fileToBeDisplayedPath,name) and (preceding-sibling::node()[@type='file']/name != '')">
					<xsl:value-of
						select="concat($path,'/',/mcr-module/iview/content/nodes/node[@type='file' and position()=1]/name)"/>
				</xsl:if>
			</xsl:for-each>
		</xsl:if>
	</xsl:template>
		...
		<xsl:if test="($fileToBeDisplayedPath != '')">
			<xsl:for-each
				...
				<xsl:if
					test="contains($fileToBeDisplayedPath,name) and (following-sibling::node()[@type='file']/name != '')">
					<xsl:value-of
						select="concat($path,'/',/mcr-module/iview/content/nodes/node[@type='file' and position()=last()]/name)"/>
				</xsl:if>
			</xsl:for-each>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template name="get.currentNodePosition">
		<xsl:if test="($fileToBeDisplayedPath != '')">
			<xsl:for-each
				...
				<xsl:if test="contains($fileToBeDisplayedPath,name)">
					<xsl:value-of
						select="count(preceding-sibling::node()[@type='file'])"/>
				</xsl:if>
			</xsl:for-each>
		</xsl:if>
	</xsl:template>
