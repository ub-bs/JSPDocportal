...
<c:choose>
   <c:when test="${empty param.workflowType}">
      <c:set var="workflowType" value="registerauthor" />
   </c:when>
   <c:otherwise>
...
<div class="headline"><fmt:message key="WorkflowEngine.StartRegisterAuthorWorkflow" /></div>
...
<c:otherwise>
     <c:import url="/content/workflow/registerauthor/authorData.jsp" />
</c:otherwise>
</c:choose>
