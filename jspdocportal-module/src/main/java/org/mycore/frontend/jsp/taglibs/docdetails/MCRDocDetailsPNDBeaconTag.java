...
public class MCRDocDetailsPNDBeaconTag extends SimpleTagSupport {
	...
	public static void main(String[] args) {
		...
		String whitelist = "mat_hr" + "|adbreg" + "|cpl" + "|dewp" + "|lagis" + "|saebi" + "|bbkl" + "|rag" + "|gesa" + "|commons" + "|gvk" + "|neerland"
				+ "|ubr_biblgr";

		String labels = "mat_hr:Rostocker Matrikelportal 1419-1945" + "|adbreg:Deutsche Biographie (ADB/NDB)" + "|cpl:Leipziger Professorenkatalog"
				+ "|dewp:Wikipedia (DE) Personenartikel" + "|lagis:Hessische Biographie" + "|mat_hr:Matrikel Rostock"
				+ "|bbkl:Biographisch-Bibliographisches Kirchenlexikon (BBKL)" + "|bmlo:Bayerisches Musiker-Lexikon Online (BMLO)"
				+ "|rag:Repertorium Academicum Germanicum (RAG)" + "|gesa:Gesamtkatalog deutschsprachiger Leichenpredigten (GESA)"
				+ "|commons:Wikimedia Commons" + "|lwl:Portal &qout;Westfälische Geschichte&qout;" + "|vr:Portal &qout;Rheinische Geschichte&qout;"
				+ "|rppd:Rheinland-Pfälzische Personendatenbank" + "|hls:Historisches Lexikon der Schweiz (HLS)" + "|ps_usbk:Portraitsammlung USB Köln"
				+ "|odb:Ostdeutsche Biographie (Kulturstiftung der deutschen Vertriebenen)" + "|sozkla:50 Klassiker der Soziologie"
				+ "|sandrart:Eintrag in der Online-Edition von Sandrarts &qout;Teutscher Academie&qout;"
				+ "|reichka:Akten der Reichskanzlei. Weimarer Republik" + "|historicum:Klassiker der Geschichtswissenschaft" + "|gvk:Verbundkatalog des GBV"
				+ "|ubr_biblgr:Rostocker Universitätsbibliographie" + "|neerland:Bio- en bibliografisch lexicon van de neerlandistiek";
