...
public class MCRThesisDerivateStrategy extends MCRDefaultDerivateStrategy {
	private static Logger logger = Logger.getLogger(MCRThesisDerivateStrategy.class.getName());
	...
	try {
		...
		for (int i = 0; files !=null && i < files.size(); i++) {
			...
			try(FileOutputStream fouts = new FileOutputStream(fout);
