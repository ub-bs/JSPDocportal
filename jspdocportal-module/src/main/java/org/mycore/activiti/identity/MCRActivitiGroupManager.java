...
public class MCRActivitiGroupManager extends GroupEntityManager {
	...
	public Group createNewGroup(String groupId) {
		throw new ActivitiException(
				"The MycoRe Activiti group manager doesn't support creating a new group");
	}

	@Override
	public void insertGroup(Group group) {
		throw new ActivitiException(
				"The MycoRe Activiti group manager doesn't support inserting a new group");
	}

	@Override
	public void updateGroup(Group updatedGroup) {
		throw new ActivitiException(
				"The MycoRe Activiti group manager doesn't support updating a new group");
	}

	@Override
	public void deleteGroup(String groupId) {
		throw new ActivitiException(
				"The MycoRe Activiti group manager doesn't support deleting a new group");
	}
