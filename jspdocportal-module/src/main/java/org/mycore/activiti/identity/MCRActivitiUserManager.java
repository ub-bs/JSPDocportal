...
public class MCRActivitiUserManager extends UserEntityManager {
	...
	public User createNewUser(String userId) {
		throw new ActivitiException(
				"The MycoRe Activiti user manager doesn't support creating a new user");
	}

	@Override
	public void insertUser(User user) {
		throw new ActivitiException(
				"The MycoRe Activiti user manager doesn't support inserting a new user");
	}

	@Override
	public void updateUser(User updatedUser) {
		throw new ActivitiException(
				"The MycoRe Activiti user manager doesn't support updating a user");
	}

	@Override
	public void deleteUser(String userId) {
		throw new ActivitiException(
				"The MycoRe Activiti user manager doesn't support deleting a user");
	}
