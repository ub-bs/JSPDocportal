    ...
    <xsl:for-each select="/mycoreobject/metadata/def.modsContainer/modsContainer/mods:mods">
      ...
      <xsl:if test="./mods:classification[@authorityURI='http://rosdok.uni-rostock.de/classifications/rosdok_class_doctypes']">
        ...
        <xsl:if test="./mods:classification[@authorityURI='http://rosdok.uni-rostock.de/classifications/DNB-DDC-SG']">
          ...
          <xsl:if test="./mods:classification[@authorityURI='http://rosdok.uni-rostock.de/classifications/rosdok_class_000000000002']">
          <tr>
            <td class="docdetails-label">Fakultät:</td>
            <td class="docdetails-values">
              <xsl:for-each select="./mods:classification[@authorityURI='http://rosdok.uni-rostock.de/classifications/rosdok_class_000000000002']/@valueURI">
               <xsl:call-template name="classLabel">
                  <xsl:with-param name="valueURI"><xsl:value-of select="." /></xsl:with-param>
               </xsl:call-template>
               <br /> 
