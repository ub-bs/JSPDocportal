					...
					<table class="frameintern">
						<tr class="result" valign="bottom" >
							<td colspan="3" valign="bottom" >
								<b><fmt:message key="Webpage.login.status.${status}" >
								<fmt:param value="${name}" /></fmt:message></b>
							</td>
						</tr>
						<tr class="result">
							<td colspan="3" > 			    
				...
				<c:otherwise>
					...
					<form method="post" action="nav?path=~login">
						...
						<div class="submitButton">&nbsp; 
							<input name="LoginSubmit" value="<fmt:message key="Webpage.login.Login" />" class="submitbutton" type="submit"> &nbsp; 
							<input name="LoginReset" value="<fmt:message key="Webpage.login.Cancel" />" class="submitbutton" type="reset">
						</div>
					</form>
				</c:otherwise>
			</c:choose>
