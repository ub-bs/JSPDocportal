...
<mcr:getWorkflowTaskBeanList var="myTaskList" mode="activeTasks" workflowTypes="series" varTotalSize="total1" />
<mcr:getWorkflowTaskBeanList var="myProcessList" mode="initiatedProcesses" workflowTypes="series" varTotalSize="total2" />
...
<c:choose>
   <c:when test="${empty myTaskList && empty myProcessList}">
      ...
      <br/>&nbsp;<br>
       <img title="" alt="" src="${baseURL}images/greenArrow.gif">
	      <a target="_self" href="${baseURL}nav?path=~seriesvolumebegin"><fmt:message key="WF.series.StartVolumeWorkflow" /></a>
	      <br/>&nbsp;<br>
      <fmt:message key="WF.common.EmptyWorkflow" />   
      <hr/>
	      <mcr:includeWebContent file="workflow/series_introtext.html"/>
    	  <br/>&nbsp;<br>
   </c:when>
