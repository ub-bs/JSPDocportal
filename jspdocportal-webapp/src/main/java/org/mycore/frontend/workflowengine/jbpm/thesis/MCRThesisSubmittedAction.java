...
public class MCRThesisSubmittedAction extends MCRAbstractAction{
	String lockedVariables;
	private static final long serialVersionUID = 1L;
	private static MCRWorkflowManagerThesis WFM = (MCRWorkflowManagerThesis)MCRWorkflowManagerFactory.getImpl("thesis");
