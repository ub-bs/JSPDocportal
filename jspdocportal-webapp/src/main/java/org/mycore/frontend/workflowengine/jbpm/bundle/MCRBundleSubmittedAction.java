...
public class MCRBundleSubmittedAction extends MCRAbstractAction{
	String lockedVariables;
	private static final long serialVersionUID = 1L;
	private static MCRWorkflowManagerBundle WFM = (MCRWorkflowManagerBundle)MCRWorkflowManagerFactory.getImpl("bundle");
