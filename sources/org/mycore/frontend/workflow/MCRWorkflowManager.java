...
public class MCRWorkflowManager {
	...
	public static synchronized MCRWorkflowManager instance() throws Exception {
		if (singleton == null)
			singleton = new MCRWorkflowManager();
		return singleton;
	}
	...
	public final boolean isDerivateOfObject(String type, String filename,
		...
		if (linkmeta == null)
			return false;
		String DID = linkmeta.getAttributeValue("href", org.jdom.Namespace
	...
	/**
	 * sets a default-rule for all objects when the objects are saved
	 * 
	 * @param objid
	 * @param userid
